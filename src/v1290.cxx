...
v1290::v1290(long handle, unsigned long address)
{
   Address=address;
   DataWidth=cvD16;
...
//	write_op_reg(Address, 0x1500); 
	...
	printf("Channels enabled :  %4X \n", (read_op_reg(Address) & 0xFFFF));

	return(0);

}

Data16 v1290::getDready()
{
 Data16 temp;
...
vector<Data32> v1290::getEventHighRateV()
{
...
Data16 v1290::read_op_reg(unsigned long Address)
{
  int time = 0;
  Data16 ro_bit;
...
Data16 v1290::write_op_reg(unsigned long Address, int code)
{
  int time = 0;
  Data16 wo_bit;
