...
typedef enum
{
	...
	CVT_V1190_MICROCONTROLLER_FW_OPCODE			= 0xC200,		/*!< \brief Read the controller firmware revision/date micro opcode */
	...
	CVT_V1190_READ_TDC_SETUP_SCAN_PATH_OPCODE	= 0xC900,		/*!< \brief Read all Setup Scan Path on TDC 0n micro opcode */
...
#define CVT_V1190_TDC_MSR_CHANNEL_MSK		0x03f80000		/*!< \brief TDC measurement CHANNEL msk */
#define CVT_V1190_TDC_MSR_MEASURE_MSK		0x0007ffff		/*!< \brief TDC measurement MEASURE msk */
...
#define CVT_V1190_GET_TDC_MSR_CHANNEL(data)		((UINT32)((((UINT32)data)& CVT_V1190_TDC_MSR_CHANNEL_MSK)>>19))			/*!< \brief Gets the TDC measurement CHANNEL number */
#define CVT_V1190_GET_TDC_HDR_MEASURE(data)		((UINT32)(((UINT32)data)& CVT_V1190_TDC_MSR_MEASURE_MSK))				/*!< \brief Gets the TDC measurement measure value */
